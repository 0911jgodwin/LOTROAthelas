...
function DragBar:Constructor(child, name)
	...
	self.screenWidth = self.screenWidth - self.child:GetWidth();
	self.screenHeight = self.screenHeight - self.child:GetHeight();
	...
	self.bar.MouseDown = function(sender, args)
		if (args.Button == Turbine.UI.MouseButton.Left) then
			self.label:SetBackground("ExoPlugins/Athelas/Resources/DragBar/BarClicked.tga");
			self.gem:SetBackground("ExoPlugins/Athelas/Resources/DragBar/GemClicked.tga");
			self.startX = args.X;
			self.startY = args.Y;
	...
	self.bar.MouseUp = function(sender, args)
		if (args.Button == Turbine.UI.MouseButton.Left) then
			self.label:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Bar.tga");
			self.gem:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Gem.tga");
			self.bar.dragging = false;
	...
	self.bar.MouseMove = function(sender, args)
		if self.bar.dragging then
			...
			self.child:SetPosition(Clamp(x, 0, self.screenWidth), Clamp(y, 20, self.screenHeight));
			self:Layout();
		end
	end
	...
	self.topLeft:SetBackground("ExoPlugins/Athelas/Resources/DragBar/TopLeft.tga");
	...
	self.top:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Top.tga");
	...
	self.topRight:SetBackground("ExoPlugins/Athelas/Resources/DragBar/TopRight.tga");

	self.right = Turbine.UI.Control();
	self.right:SetParent(self.shadowBox);
	self.right:SetSize(10, 10);
	self.right:SetMouseVisible(false);
	self.right:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Right.tga");
	...
	self.bottomRight:SetBackground("ExoPlugins/Athelas/Resources/DragBar/BottomRight.tga");
	...
	self.bottom:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Bottom.tga");
	...
	self.bottomLeft:SetBackground("ExoPlugins/Athelas/Resources/DragBar/BottomLeft.tga");
	...
	self.left:SetBackground("ExoPlugins/Athelas/Resources/DragBar/Left.tga");
